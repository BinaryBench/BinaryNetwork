package me.binarynetwork.core.entity.controllablemobs.api.attributes;

/**
 * An interface representing an attribute of a controllable mob.
 * Use one of the various methods located at {@link me.binarynetwork.core.entity.controllablemobs.api.ControllableMobAttributes} to retrieve an attribute instance.
 * 
 * @author Cybran
 * @version v4
 *
