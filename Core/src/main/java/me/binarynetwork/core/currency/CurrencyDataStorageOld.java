 ...
 */
public class CurrencyDataStorageOld extends PlayerDataStorage<Map<Currency, Integer>> {
    ...
    public CurrencyDataStorageOld(ScheduledExecutorService scheduler, AccountManagerOld accountManager)
    {
