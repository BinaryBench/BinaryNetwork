 ...
 */
public class CurrencyDataCacheNew extends PlayerDataStorageNew<Map<Currency, Integer>> {
    ...
    public CurrencyDataCacheNew(ScheduledExecutorService scheduler, AccountManagerNew accountManager)
    {
    ...
    @Override
    public Map<Currency, Integer> loadTemp(Account key)
    {
        return new HashMap<>();
    }
