...
public interface ControllableMobAttributes {
	 ...
	 * Impacts all aspects of entity movement, whether invoked by {@link ControllableMobActions#moveTo(org.bukkit.Location)}, {@link ControllableMobActions#follow(org.bukkit.entity.LivingEntity)} or {@link me.binarynetwork.core.entity.controllablemobs.api.ai.behaviors.AIAttackMelee} (etc.) is not important.
	...
	/**
	 * Determines whether the entity can swim. To change this value, add or remove {@link me.binarynetwork.core.entity.controllablemobs.api.ai.behaviors.AISwim} to {@link ControllableMobAI}
	 ...
	 * To adjust this behavior, add or remove either {@link me.binarynetwork.core.entity.controllablemobs.api.ai.behaviors.AIDoorOpen} or {@link me.binarynetwork.core.entity.controllablemobs.api.ai.behaviors.AIDoorBreak} to {@link ControllableMobAI}.
