...
public class RunnerGame extends SimpleComponentWrapper {
    ...
    public RunnerGame(PlayerHolder playerHolder, ScheduledExecutorService scheduler, Supplier<World> lobbyWorldComponent, Runnable onEnd)
    {
        ...
        manager.add(new LMSVictoryCondition(spectateManager.getNonSpectateHolder(), 0, playerHolder, manager.getSetStateRunnable(GameState.POST_GAME)), GameState.PRE_GAME, GameState.GAME);
