package me.binarynetwork.game.games.spleef;
 ...
 */
public class SpleefGame extends SimpleComponentWrapper {
    ...
    public SpleefGame(PlayerHolder playerHolder, ScheduledExecutorService scheduler, LobbyWorldComponent lobbyWorldComponent, Runnable onEnd)
    {
        ...
        // Runner Game
        manager.add(new SpleefComponent(spectateManager.getNonSpectateHolder(), worldManager), GameState.GAME);
